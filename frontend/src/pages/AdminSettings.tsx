...
const SETTING_LABELS: Record<string, string> = {
    ...
    'AI_MONTHLY_LIMIT_FREE': 'Consultas IA Mensuales (Gratuito)',
    'AI_MONTHLY_LIMIT_PREMIUM': 'Consultas IA Mensuales (Premium)',
...
const HELP_TEXTS: Record<string, string> = {
    ...
    'AI_MONTHLY_LIMIT_FREE': 'Número de consultas al chat IA por mes (Gratuito)',
    'AI_MONTHLY_LIMIT_PREMIUM': 'Número de consultas al chat IA por mes (Premium)',
...
const AI_PROVIDERS = [
    ...
    { id: 'gemini', name: 'Google Gemini', models: ['gemini-2.5-pro', 'gemini-1.5-flash', 'gemini-pro'] },
